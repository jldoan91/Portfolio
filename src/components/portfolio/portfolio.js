        ...
        return (
            <div className={styles.portfolio}>
                ...
                <div className={styles.projects}>
                    <Project title="Unbeatable Tic-Tac-Toe" picture="src/components/portfolio/img/tictactoess.png" description={<p>An unbeatable tic tac toe game built with the minimax algorithm using</p>} technologies={<p>{this.state.node} + {this.state.react}</p>} github='https://github.com/jldoan91/tictactoe' app='https://jldoantictactoe.herokuapp.com/' />
