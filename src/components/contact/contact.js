        ...
        return (
            <div className={this.props.shrink ? `${styles.shrunk} ${styles.contact}` : styles.contact}>
                ...
                <div className={styles.socialmedia}>
                    <a className={styles.socialIcon} href="https://www.linkedin.com/in/josh-doan-328995138" target="_blank"><i className={`fab fa-linkedin fa-3x ${styles.icon}`}></i></a>
                    <a className={styles.socialIcon} href="https://github.com/jldoan91" target="_blank"><i className={`fab fa-github-square fa-3x ${styles.icon}`}></i></a>
                    <a className={styles.socialIcon} href="https://www.facebook.com/josh.doan.54" target="_blank"><i className={`fab fa-facebook-square fa-3x ${styles.icon}`}></i></a>
                    <a className={styles.socialIcon} href="https://twitter.com/jldoan91" target="_blank"><i className={`fab fa-twitter-square fa-3x ${styles.icon}`}></i></a>
                </div>
            </div >
        )
    }
